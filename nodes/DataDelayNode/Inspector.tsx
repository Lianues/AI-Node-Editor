...
const DataDelayNodeInspector: React.FC<
...
> = ({ node, updateNodeData, executionDetails, customTools }) => {
  ...
  if (!nodeDefinition) {
    return <p className={`text-sm ${inspectorTheme.warningText}`}>无法加载数据延迟节点的检查器：节点定义未找到。</p>;
  }
...
export default DataDelayNodeInspector;