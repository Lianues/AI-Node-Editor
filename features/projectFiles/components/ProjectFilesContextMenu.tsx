...
import { ProjectFileContextMenuComponentProps } from '../types/projectFilesContextMenuTypes';
import { vscodeDarkTheme } from '../../../theme/vscodeDark';

export const ProjectFilesContextMenu: React.FC<ProjectFileContextMenuComponentProps> = ({ menuConfig, onClose }) => {
  const menuRef = useRef<HTMLDivElement>(null);
  const theme = vscodeDarkTheme.contextMenu; // Using general context menu theme
