// features/subworkflows/components/SubWorkflowContextMenu.tsx
import React, { useEffect, useRef } from 'react';
import { SubWorkflowContextMenuComponentProps } from '../types/subWorkflowContextMenuTypes';
import { vscodeDarkTheme } from '../../../theme/vscodeDark';

export const SubWorkflowContextMenu: React.FC<SubWorkflowContextMenuComponentProps> = ({ menuConfig, onClose }) => {
  ...
  const { x, y, items, targetSubWorkflowId } = menuConfig;
          ...
          <button
            ...
            onClick={() => {
              if (!item.disabled && item.onClick) {
                item.onClick({ targetSubWorkflowId });
                onClose(); 
